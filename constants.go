...
const (
	...
	DBT_DEVTYP_DEVNODE          = 0x00000001 // devnode number#if(WINVER >= 0x040A)
	DBT_DEVTYP_VOLUME           = 0x00000002 // logical volume#define DBT_CUSTOMEVENT                 0x8006  // user-defined event
	DBT_DEVTYP_PORT             = 0x00000003 // serial, parallel#endif /* WINVER >= 0x040A */
